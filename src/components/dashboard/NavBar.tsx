...
import { LayoutDashboard, FolderOpen, FileText, Shield, ChevronDown, LogOut, User, Bell } from "lucide-react";
...
export default function NavBar() {
  ...
  const isFullAccess = accessTier === "full";
